...
#include <memory>
#include "../../VoidTerminal/dialogs/skin.h"
...
QT_MOC_LITERAL(1, 5, 14), // "sig_changeSkin"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 5), // "index"
QT_MOC_LITERAL(4, 27, 17), // "on_btn_ok_clicked"
QT_MOC_LITERAL(5, 45, 21) // "on_btn_cancel_clicked"

    },
    "Skin\0sig_changeSkin\0\0index\0on_btn_ok_clicked\0"
...
void Skin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sig_changeSkin((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            using _t = void (Skin::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Skin::sig_changeSkin)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Skin::sig_changeSkin(int _t1)
{
